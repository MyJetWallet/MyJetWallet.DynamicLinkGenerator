...
namespace MyJetWallet.DynamicLinkGenerator.Services
{
    public class DynamicLinkClient : IDynamicLinkClient
    {
        ...
        public (string longLink, string shortLink) GenerateMarketsScreenLink(MarketsScreenRequest request) => GenerateDeepLink(ActionEnum.MarketsScreen, request.Brand, ("jw_symbol", request.FromAsset), ("jw_fromAsset", request.FromAsset), ("jw_toAsset", request.ToAsset), ("jw_amount", request.Amount), ("jw_side", request.BuyFixed ? "buy" : "sell"));
